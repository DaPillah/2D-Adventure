...
public class PlayerFireball : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Enemy") && !alreadyHit.Contains(other.gameObject) && impactsLeft > 0)
        {
            //Add the enemy to the list
            alreadyHit.Add(other.gameObject);
            impactsLeft--;

            //[Audio] Play a sound if it passes through an enemy
            if (impactsLeft > 0)
                sounds.PlayOneShot(sounds.audio_magicPassThrough);
    ...
    public void Impact()
    {
        ...
        //[Extra] Play impact sound
        sounds.PlayOneShot(sounds.audio_magicImpact);
    ...
    public void aoeExplosion()
    {
        ...
        //[Extra] Play explosion sound
        sounds.PlayOneShot(sounds.audio_magicExplode);
